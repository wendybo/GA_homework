...
'''
#1
fam_names = ["Wendy", "Erick", "Nell"]
#2
print fam_names[-1]
#3
print len(fam_names[0])
#4
fam_names[1] = "E"
#5
fam_names.append("Malcolm")
#6
fam_names[-1] = fam_names[-1].lower()
#7
rev_names = sorted(fam_names, key=lambda v: (v.upper(), v[0].islower()), reverse = True)
print rev_names

#bonus
len_names = sorted(fam_names, key = len)
print len_names
...
# EXERCISE 2
word = 'abc'
up_list = [letter.upper() for letter in word]
print up_list

# EXERCISE 3
fruits = ['Apple', 'Banana', 'Cherry']
first_let = [fruit[0].upper() for fruit in fruits]
print first_let
...
for kid in family['kids']:
    kid_name = kid[0].upper() + kid[1:]
    new_kids.append(kid_name)
print new_kids
family['kids'] = new_kids
print family['kids']

#bonus
new_kids = [kid[0].upper() + kid[1:] for kid in family['kids']]
print new_kids
